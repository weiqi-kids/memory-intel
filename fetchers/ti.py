...
class TIFetcher(CompanyFetcher):
    """Texas Instruments 爬蟲"""

    company_id = "ti"
    company_name = "Texas Instruments"
    news_url = "https://news.ti.com/"
    ir_url = "https://investor.ti.com/financial-info/quarterly-results"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Texas Instruments")
        return documents
