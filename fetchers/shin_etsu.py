...
class ShinEtsuFetcher(CompanyFetcher):
    """Shin-Etsu Chemical 爬蟲"""

    company_id = "shin_etsu"
    company_name = "Shin-Etsu Chemical"
    news_url = "https://www.shinetsu.co.jp/en/news/"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.shinetsu.co.jp" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Shin-Etsu Chemical")
        return documents
