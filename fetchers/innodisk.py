...
class InnodiskFetcher(CompanyFetcher):
    """Innodisk 爬蟲"""

    company_id = "innodisk"
    company_name = "Innodisk"
    news_url = "https://www.innodisk.com/en/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.innodisk.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Innodisk")
        return documents
