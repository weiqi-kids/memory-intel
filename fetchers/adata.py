...
class AdataFetcher(CompanyFetcher):
    """ADATA Technology 爬蟲"""

    company_id = "adata"
    company_name = "ADATA Technology"
    news_url = "https://www.adata.com/en/news/"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from ADATA Technology")
        return documents
