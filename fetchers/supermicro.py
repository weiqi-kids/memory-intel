...
class SupermicroFetcher(CompanyFetcher):
    """Super Micro Computer 爬蟲"""
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.supermicro.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Super Micro Computer")
        return documents
