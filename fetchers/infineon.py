...
class InfineonFetcher(CompanyFetcher):
    """Infineon Technologies 爬蟲"""

    company_id = "infineon"
    company_name = "Infineon Technologies"
    news_url = "https://www.infineon.com/cms/en/about-infineon/press/press-releases/"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.infineon.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Infineon Technologies")
        return documents
