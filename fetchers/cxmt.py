"""
ChangXin Memory Technologies 官網爬蟲
"""
...
class CXMTFetcher(CompanyFetcher):
    """ChangXin Memory Technologies 爬蟲"""

    company_id = "cxmt"
    company_name = "ChangXin Memory Technologies"
    news_url = "https://www.cxmt.com/en/news.html"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from ChangXin Memory Technologies")
        return documents
