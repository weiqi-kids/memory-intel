...
class SynopsysFetcher(CompanyFetcher):
    """Synopsys 爬蟲"""

    company_id = "synopsys"
    company_name = "Synopsys"
    news_url = "https://news.synopsys.com/"
    ir_url = "https://investor.synopsys.com/financial-info/quarterly-results"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://news.synopsys.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Synopsys")
        return documents
