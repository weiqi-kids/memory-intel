...
class LenovoFetcher(CompanyFetcher):
    """Lenovo 爬蟲"""

    company_id = "lenovo"
    company_name = "Lenovo"
    news_url = "https://news.lenovo.com/pressroom/press-releases/"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Lenovo")
        return documents
