...
class IntelFetcher(CompanyFetcher):
    """Intel 爬蟲"""

    company_id = "intel"
    company_name = "Intel"
    news_url = "https://www.intc.com/news-events/press-releases"
    ir_url = "https://www.intc.com/financial-info/quarterly-results"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Intel")
        return documents
