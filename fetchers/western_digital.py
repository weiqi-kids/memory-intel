...
class WesternDigitalFetcher(CompanyFetcher):
    """Western Digital 爬蟲"""

    company_id = "western_digital"
    company_name = "Western Digital"
    news_url = "https://www.westerndigital.com/company/newsroom"
    ir_url = "https://investor.wdc.com/financial-information/quarterly-results"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.westerndigital.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Western Digital")
        return documents
