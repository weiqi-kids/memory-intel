...
class PSMCFetcher(CompanyFetcher):
    """Powerchip Semiconductor 爬蟲"""
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Powerchip Semiconductor")
        return documents
