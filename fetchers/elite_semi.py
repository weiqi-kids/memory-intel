...
class EliteSemiFetcher(CompanyFetcher):
    """Elite Semiconductor 爬蟲"""
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Elite Semiconductor")
        return documents
