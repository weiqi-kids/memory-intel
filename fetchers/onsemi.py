...
class OnsemiFetcher(CompanyFetcher):
    """ON Semiconductor 爬蟲"""

    company_id = "onsemi"
    company_name = "ON Semiconductor"
    news_url = "https://www.onsemi.com/company/news-media/in-the-news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from ON Semiconductor")
        return documents
