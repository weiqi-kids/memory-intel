...
class BroadcomFetcher(CompanyFetcher):
    """Broadcom 爬蟲"""

    company_id = "broadcom"
    company_name = "Broadcom"
    news_url = "https://www.broadcom.com/company/news"
    ir_url = "https://investors.broadcom.com/financial-information/quarterly-results"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.broadcom.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Broadcom")
        return documents
