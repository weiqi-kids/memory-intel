...
class SiliconMotionFetcher(CompanyFetcher):
    """Silicon Motion 爬蟲"""

    company_id = "silicon_motion"
    company_name = "Silicon Motion"
    news_url = "https://www.siliconmotion.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.siliconmotion.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Silicon Motion")
        return documents
