...
class HPFetcher(CompanyFetcher):
    """HP Inc. 爬蟲"""

    company_id = "hp"
    company_name = "HP Inc."
    news_url = "https://press.hp.com/us/en/press-releases.html"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from HP Inc.")
        return documents
