...
class ArmFetcher(CompanyFetcher):
    """Arm Holdings 爬蟲"""

    company_id = "arm"
    company_name = "Arm Holdings"
    news_url = "https://newsroom.arm.com/news"
    ir_url = "https://investors.arm.com/financial-info/quarterly-results"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://newsroom.arm.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Arm Holdings")
        return documents
