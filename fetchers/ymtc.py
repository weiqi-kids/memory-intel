"""
Yangtze Memory Technologies 官網爬蟲
"""
...
class YMTCFetcher(CompanyFetcher):
    """Yangtze Memory Technologies 爬蟲"""

    company_id = "ymtc"
    company_name = "Yangtze Memory Technologies"
    news_url = "https://www.ymtc.com/en/news/"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Yangtze Memory Technologies")
        return documents
