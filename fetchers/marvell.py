...
class MarvellFetcher(CompanyFetcher):
    """Marvell Technology 爬蟲"""
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Marvell Technology")
        return documents
