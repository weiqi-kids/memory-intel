...
class AmkorFetcher(CompanyFetcher):
    """Amkor Technology 爬蟲"""

    company_id = "amkor"
    company_name = "Amkor Technology"
    news_url = "https://www.amkor.com/news/"
    ir_url = "https://investor.amkor.com/financial-info/quarterly-results"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Amkor Technology")
        return documents
