...
class CadenceFetcher(CompanyFetcher):
    """Cadence Design Systems 爬蟲"""
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Cadence Design Systems")
        return documents
