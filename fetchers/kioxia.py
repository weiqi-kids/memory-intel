...
class KioxiaFetcher(CompanyFetcher):
    """Kioxia 爬蟲"""

    company_id = "kioxia"
    company_name = "Kioxia"
    news_url = "https://www.kioxia.com/en-jp/news/"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Kioxia")
        return documents
