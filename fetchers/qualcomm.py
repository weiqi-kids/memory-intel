...
class QualcommFetcher(CompanyFetcher):
    """Qualcomm 爬蟲"""

    company_id = "qualcomm"
    company_name = "Qualcomm"
    news_url = "https://www.qualcomm.com/news/releases"
    ir_url = "https://investor.qualcomm.com/financial-info/quarterly-results"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.qualcomm.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Qualcomm")
        return documents
